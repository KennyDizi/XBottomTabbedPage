...
namespace BottomNavigationBar
{
    ...
    /// BottomBarBadge
    /// </summary>
    public sealed class BottomBarBadge : TextView, ViewTreeObserver.IOnGlobalLayoutListener
    {
        ...
        public long AnimationDuration { get; set; } = 150;
        ...
        private void AdjustPosition(View tabToAddTo) 
        {

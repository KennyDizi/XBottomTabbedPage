...
{
    public class XHomeTabbedPage : XWellcareBottomTabbedPage
    {
        public XHomeTabbedPage()
        {
            ...
            var navPage1 = new XWellcareNavigationPage(root: viewRootPage1) {BarTextColor = Color.White};
            // set tab color
            ...
            var navPage2 = new XWellcareNavigationPage(root: viewRootPage2) { BarTextColor = Color.White };
            // set tab color
            ...
            var navPage3 = new XWellcareNavigationPage(root: viewRootPage3) { BarTextColor = Color.White };
            // set tab color
            ...
            var navPage4 = new XWellcareNavigationPage(root: viewRootPage4) { BarTextColor = Color.White };
            // set tab color
